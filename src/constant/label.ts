...
export const DbObjectTypeTextMap = (type: DbObjectType) => {
  const textMap = {
    ...
    [DbObjectType.column]: formatMessage({
      id: 'src.constant.8D87AF25',
      defaultMessage: '列'
    }),

    //程序包体
    [DbObjectType.trigger]: formatMessage({
      id: 'odc.src.d.ts.Trigger',
      defaultMessage: '触发器'
    }), // 触发器
...
export const ConnectTypeText = (type: ConnectType) => {
  const textMap = {
    ...
    [ConnectType.OSS]: formatMessage({
      id: 'src.constant.547E5EFD',
      defaultMessage: '阿里云 OSS'
    }),
    [ConnectType.COS]: formatMessage({
      id: 'src.constant.D988A13A',
      defaultMessage: '腾讯云 COS'
    }),
    [ConnectType.OBS]: formatMessage({
...
export const DBTypeText = {
  [DBType.LOGICAL]: formatMessage({
    id: 'src.constant.D2F0EBE8',
    defaultMessage: '逻辑库'
  }),
  [DBType.PHYSICAL]: formatMessage({
...
export const SQLLintModeText = {
  [SQLLintMode.AUTO]: formatMessage({
    id: 'odc.src.d.ts.Automatic',
    defaultMessage: '自动'
  }), //自动
  [SQLLintMode.MANUAL]: formatMessage({
    id: 'odc.src.d.ts.Manual',
    defaultMessage: '手动'
  }) //手动
};
...
export const columnGroupsText = {
  [ColumnStoreType.COLUMN]: formatMessage({
    id: 'src.constant.CE5A59D0',
    defaultMessage: '列存'
  }),
  [ColumnStoreType.ROW]: formatMessage({
    id: 'src.constant.481BAC23',
    defaultMessage: '行存'
  })
};
...
export const refreshScheduleUnitText = {
  ...
  [RefreshScheduleUnit.HOUR]: formatMessage({
    id: 'src.constant.A786DCEF',
    defaultMessage: '时'
  }),
  [RefreshScheduleUnit.DAY]: formatMessage({
    id: 'src.constant.F847D32E',
    defaultMessage: '天'
  }),
  [RefreshScheduleUnit.WEEK]: formatMessage({
    id: 'src.constant.15130867',
    defaultMessage: '周'
  }),
  [RefreshScheduleUnit.MONTH]: formatMessage({
    id: 'src.constant.7959241A',
    defaultMessage: '月'
  }),
  [RefreshScheduleUnit.YEAR]: formatMessage({
    id: 'src.constant.0DFA8CD7',
    defaultMessage: '年'
  })
};
