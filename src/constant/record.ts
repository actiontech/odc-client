...
export const AuditEventMetaMap = {
  ...
  [AuditEventType.DATABASE_CHANGE_CHANGING_ORDER_TEMPLATE_MANAGEMENT]:
    formatMessage({
...
export const AuditEventActionMap = {
  ...
  // #region ---- 多库变更模版管理 ----
  [AuditEventActionType.CREATE_DATABASE_CHANGE_CHANGING_ORDER_TEMPLATE]:
    formatMessage({
      id: 'src.constant.394E7917',
      defaultMessage: '创建数据库变更顺序模板\t'
    }),
  [AuditEventActionType.DELETE_DATABASE_CHANGE_CHANGING_ORDER_TEMPLATE]:
    formatMessage({
      id: 'src.constant.311737C9',
      defaultMessage: '删除数据库变更顺序模板\t'
    }),
  [AuditEventActionType.UPDATE_DATABASE_CHANGE_CHANGING_ORDER_TEMPLATE]:
    formatMessage({
