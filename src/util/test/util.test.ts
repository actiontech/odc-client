...
describe('test utils', () => {
  ...
  it('getCurrentSql', () => {
    expect(getCurrentSQL('select * from a;', 0, true, ';')).toEqual(
      'select * from a;'
    );
    expect(getCurrentSQL(' select * from a;', 0, true, ';')).toEqual(
      ' select * from a;'
    ...
    expect(
      getCurrentSQL(' select * from a; ', ' select * from a;'.length, true, ';')
    ).toEqual(' select * from a;');
    expect(
      getCurrentSQL(
        ' select * from a; ',
        ' select * from a; '.length,
        true,
        ';'
      )
    ).toEqual(' select * from a;');
    ...
    expect(getCurrentSQL(`select * from \`a;--sd\`;`, 1, false, ';')).toEqual(
      'select * from `a;'
    );
