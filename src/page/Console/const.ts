...
export const ConsoleTextConfig = {
  schdules: {
    ...
    status: [
      formatMessage({
        id: 'src.page.Console.4D58E4BD',
        defaultMessage: '执行成功'
      }),
      formatMessage({
        id: 'src.page.Console.0DE02703',
        defaultMessage: '执行失败'
      }),
      formatMessage({
        id: 'src.page.Console.095A8212',
        defaultMessage: '执行中'
      }),
      formatMessage({
        id: 'src.page.Console.A46DFDCA',
        defaultMessage: '待执行'
      }),
  ...
  quickStart: {
    role: [
      formatMessage({
        id: 'src.page.Console.AF3D84A0',
        defaultMessage: '我是管理员'
      }),
      formatMessage({
        id: 'src.page.Console.2D54E921',
        defaultMessage: '我是开发者'
      })
    ],
    ...
    steps: [
      [
        formatMessage({
          id: 'src.page.Console.170470F0',
          defaultMessage: '添加数据源'
        }),
        formatMessage({
          id: 'src.page.Console.E7995F1C',
          defaultMessage: '创建项目并分配数据库'
        }),
        formatMessage({
          id: 'src.page.Console.FAF37E03',
          defaultMessage: '管理风险规则和审批流'
        }),
        formatMessage({
          id: 'src.page.Console.1A6CAD7C',
          defaultMessage: '发起一个工单'
        })
      ],

      [
        formatMessage({
          id: 'src.page.Console.2994ACD6',
          defaultMessage: '加入一个项目'
        }),
        formatMessage({
          id: 'src.page.Console.BA100E5E',
          defaultMessage: '生成测试数据'
        }),
        formatMessage({
          id: 'src.page.Console.DD9DC97D',
          defaultMessage: '体验 SQL 查询和开发'
        })
      ]
    ]
  },
  recently: {
    columnNames: [
      formatMessage({
        id: 'src.page.Console.F938665F',
        defaultMessage: '数据库名称'
      }),
      formatMessage({
        id: 'src.page.Console.41896A1C',
        defaultMessage: '所属数据源'
      }),
      formatMessage({
        id: 'src.page.Console.385D9101',
        defaultMessage: '所属项目'
      }),
      formatMessage({
        id: 'src.page.Console.3F90E879',
        defaultMessage: '环境'
      }),
  ...
  aboutUs: {
    helps: [
      formatMessage({
        id: 'src.page.Console.D66A7480',
        defaultMessage: '下载新版'
      }),
      formatMessage({
        id: 'src.page.Console.B27ADAC6',
        defaultMessage: '产品动态'
      }),
      formatMessage({
        id: 'src.page.Console.9B6E647E',
        defaultMessage: '反馈建议'
      })
    ],
