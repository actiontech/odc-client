...
export const menuAccessWrap = (
  ...
  if (
    needPermissionTypeList.every((element) => permissionList.includes(element))
  ) {
    return menuNode;
  }
  return (
...
export const databaseMenusConfig: Partial<
  ...
  [ResourceNodeType.Database]: [
      ...
      isHide(_, node) {
        ...
        return (
          ...
          config?.features?.task?.every(
            (i) => ![TaskType.EXPORT_RESULT_SET]?.includes(i)
          )
        );
      },
      children: [
    ...
    },
    {
      ...
      children: [
        ...
        //   isHide(_, node) {
        //     return (
        //       !setting.enableLogicaldatabase || !isLogicalDatabase(node.data)
        //     );
        //   },
        //   run(session, node) {
