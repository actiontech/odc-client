...
export function getItems(
  ...
  const cantBeModified =
    [TaskStatus.EXECUTING]?.includes(status) && haveOperationPermission;
  if (!task) {
    return [];
  }
  ...
  return [
    {
      ...
      textItems: [
        ...
        [
          ...
          LockStrategyLableMap[
            parameters?.forbiddenWriteType || LockStrategy.LOCK_USER
          ]
        ],
        ...
        [
          null,
          <SQLContentSection task={task} key={task.id} theme={theme} />,
          2
        ],
