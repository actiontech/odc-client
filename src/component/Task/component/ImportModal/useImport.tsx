...
export const useImport = (
  ...
  const config = {
    api: {
      ...
      submit: (params: IScheduleTaskImportRequest) =>
        taskInfo?.submitApi?.(params)
    },
    isTaskCompleted: (result: IImportTaskResult[]) =>
      taskInfo?.isTaskCompleted?.(result),
