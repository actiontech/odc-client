...
const webVersionInfo: VersionMenuType[] = [
  {
    title: formatMessage({
      id: 'src.component.VersionModal.FF9A170D',
      defaultMessage: '协同开发'
    }),
    content: (
      <div>
  ...
  {
    title: formatMessage({
      id: 'src.component.VersionModal.44E513D9',
      defaultMessage: 'SQL 开发'
    }),
    content: (
      <div>
        <Paragraph className={styles.paragraph}>
  ...
  {
    title: formatMessage({
      id: 'src.component.VersionModal.EFD3D7AA',
      defaultMessage: '历史库'
    }),
    content: (
      <div>
        <Paragraph className={styles.paragraph}>
          ...
          <div>
            {formatMessage({
              ...
              defaultMessage:
                '多线程并发：任务采用多个线程并发处理机制来保证数据传输的性能。'
            })}
          </div>
          <div>
            {formatMessage({
