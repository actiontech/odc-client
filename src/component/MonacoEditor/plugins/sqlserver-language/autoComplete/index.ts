...
class SQLServerAutoComplete implements monaco.languages.CompletionItemProvider {
  triggerCharacters?: string[] | undefined = ['.'];
  private modelOptionsMap: Map<string, ISQLServerModelOptions | null> =
    new Map();
  ...
  private getModelOptions(modelId: string): ISQLServerModelOptions | null {
    ...
    for (const context of contexts) {
      switch (context.type) {
        ...
        case 'allTables': {
          ...
          // schemaName 可能为 undefined，表示不限定 schema
...
export default SQLServerAutoComplete;
