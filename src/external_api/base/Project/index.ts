...
class ProjectService extends ServiceBase {
  public ListProjects(params: IListProjectsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.get<IListProjectsReturn>('/v1/dms/projects', paramsData, options);
  }

  public AddProject(params: IAddProjectParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.post<IAddProjectReturn>('/v1/dms/projects', paramsData, options);
  }

  public ListBusinessTags(params: IListBusinessTagsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.get<IListBusinessTagsReturn>('/v1/dms/projects/business_tags', paramsData, options);
  }

  public CreateBusinessTag(params: ICreateBusinessTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
  ...
  public UpdateBusinessTag(params: IUpdateBusinessTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
  ...
  public DeleteBusinessTag(params: IDeleteBusinessTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const business_tag_uid = paramsData.business_tag_uid;
    delete paramsData.business_tag_uid;
  ...
  public DBServicesConnection(params: IDBServicesConnectionParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
  ...
  public ExportProjects(params: IExportProjectsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.get('/v1/dms/projects/export', paramsData, options);
  }

  public ImportProjects(params: IImportProjectsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.post<IImportProjectsReturn>('/v1/dms/projects/import', paramsData, options);
  }
  ...
  public ImportDBServicesOfProjectsCheck(
    ...
    return this.post('/v1/dms/projects/import_db_services_check', paramsData, config);
  }

  public GetImportDBServicesTemplate(options?: AxiosRequestConfig) {
    return this.get('/v1/dms/projects/import_db_services_template', undefined, options);
  }
  ...
  public PreviewImportProjects(params: IPreviewImportProjectsParams, options?: AxiosRequestConfig) {
    const config = options || {};
    const headers = config.headers ? config.headers : {};
    config.headers = {
      ...headers,
  ...
  public GetProjectTips(params: IGetProjectTipsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.get<IGetProjectTipsReturn>('/v1/dms/projects/tips', paramsData, options);
  }

  public UpdateProject(params: IUpdateProjectParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;

    return this.put<IUpdateProjectReturn>(`/v1/dms/projects/${project_uid}`, paramsData, options);
  }
  ...
  public DelProject(params: IDelProjectParams, options?: AxiosRequestConfig) {
    ...
    return this.delete<IDelProjectReturn>(`/v1/dms/projects/${project_uid}`, paramsData, options);
  }

  public ArchiveProject(params: IArchiveProjectParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public ListEnvironmentTags(params: IListEnvironmentTagsParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public CreateEnvironmentTag(params: ICreateEnvironmentTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public UpdateEnvironmentTag(params: IUpdateEnvironmentTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public DeleteEnvironmentTag(params: IDeleteEnvironmentTagParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public UnarchiveProject(params: IUnarchiveProjectParams, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;
  ...
  public ListProjectsV2(params: IListProjectsV2Params, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.get<IListProjectsV2Return>('/v2/dms/projects', paramsData, options);
  }

  public AddProjectV2(params: IAddProjectV2Params, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.post<IAddProjectV2Return>('/v2/dms/projects', paramsData, options);
  }

  public ImportProjectsV2(params: IImportProjectsV2Params, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    return this.post<IImportProjectsV2Return>('/v2/dms/projects/import', paramsData, options);
  }
  ...
  public ImportDBServicesOfProjectsCheckV2(
    ...
    return this.post('/v2/dms/projects/import_db_services_check', paramsData, config);
  }
  ...
  public UpdateProjectV2(params: IUpdateProjectV2Params, options?: AxiosRequestConfig) {
    const paramsData = this.cloneDeep(params);
    const project_uid = paramsData.project_uid;
    delete paramsData.project_uid;

    return this.put<IUpdateProjectV2Return>(`/v2/dms/projects/${project_uid}`, paramsData, options);
  }
}
